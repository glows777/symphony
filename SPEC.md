...
- Manual rerun actions for blocked issues are explicit operator actions: dashboard affordances must
  ask for confirmation before posting, and server-rendered form submissions redirect back to the
  dashboard after a successful enqueue.
